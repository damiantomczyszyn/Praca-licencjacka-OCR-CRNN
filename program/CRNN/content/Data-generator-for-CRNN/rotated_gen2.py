...
for _ in range(args.n_samples):
    ...
    back_c=back_c.resize(((int)(w)+5,(int)(h+5)))
    ...
    draw2 = ImageDraw.Draw(back_c)
    draw2.text((0, 0), text=word, font=font, fill=(0))
   # image2.show()
    angle = random.randrange(-5,5)
    back_c = back_c.rotate(angle, resample=Image.BICUBIC, expand=True)
    #image2.show()
    #sx, sy = image2.size
    #back_c.paste(image2, (10, 10, 10 + sx, 10 + sy), image2)
